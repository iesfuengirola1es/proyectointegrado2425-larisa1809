...
public class ChatActivity extends AppCompatActivity {
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(message.trim().length()>0)
                {
                    ...
                    Toast.makeText(ChatActivity.this, "Mensaje no puede ser vacio!", Toast.LENGTH_SHORT).show();
        ...
        dbReferenceSender.child(messageId).setValue(messageModel)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ChatActivity.this, "No ha salido bien, intentalo por nuevo", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId()==R.id.logout){
            ...
            startActivity(new Intent(ChatActivity.this, SigningActivity.class));
            finish();
            return true;
        }
        return false;
